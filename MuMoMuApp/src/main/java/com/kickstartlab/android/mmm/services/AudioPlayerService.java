package com.kickstartlab.android.mmm.services;
...
import com.kickstartlab.android.mmm.events.PlayerEvent;
...
public class AudioPlayerService extends Service implements
    ...
    public void onBufferingUpdate(MediaPlayer mediaPlayer, int i) {
        EventBus.getDefault().post(new PlayerEvent(PlayerEvent.BUFFERING_UPDATE, i));
    }
    ...
    private void sendBufferingBroadcast() {
        ...
        EventBus.getDefault().post(new PlayerEvent(PlayerEvent.BUFFERING));
    }
    ...
    private void sendBufferCompleteBroadcast() {
        ...
        //sendBroadcast(bufferIntent);
        EventBus.getDefault().post(new PlayerEvent(PlayerEvent.BUFFERING_COMPLETE));
    }
